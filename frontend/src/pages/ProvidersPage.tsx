    ...
    <div className="page-body">
      <div className="card" style={{ borderLeft: '4px solid var(--accent-mint)' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: '13px', lineHeight: 1.5 }}>
          The system strictly enforces the provider priority: Local/Open-Source (Edge-TTS, FFmpeg) &gt; Free Web Research &gt; Free OpenRouter/Groq LLMs &gt; Licensed Free Stock &gt; Official Meta Graph API v19.0+ container publishing. Any paid call is halted outright when Zero-Cost Mode is enabled.
        </p>
      </div>
